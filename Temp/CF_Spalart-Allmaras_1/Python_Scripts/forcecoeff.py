...
postProcessingDir = '/home/manascfd/Masters_Projects_Main/CF_Spalart-Allmaras_1/postProcessing/forceCoeffs/0'
...
forceCoeffs_file = os.path.join(postProcessingDir, 'coefficient.dat')
